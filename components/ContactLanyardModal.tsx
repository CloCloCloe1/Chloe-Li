...
export default function ContactLanyardModal({
  ...
  return (
    <div className="fixed inset-0 z-[120] flex items-center justify-center overflow-y-auto bg-black/70 px-4 py-8 backdrop-blur-xl">
      <button
      ...
      <div
        ...
        aria-modal="true"
        className="lanyard-modal relative z-10 w-full max-w-[430px]"
        ref={dialogRef}
        role="dialog"
      >
        ...
        <article className="lanyard-card liquid-glass-strong text-white">
          <button
            aria-label="Close contact card"
            className="absolute right-4 top-4 inline-flex h-10 w-10 items-center justify-center rounded-full bg-white/12 text-white transition hover:bg-white/20 focus-ring"
            onClick={onClose}
            type="button"
          >
          ...
          <div className="rounded-[1.5rem] bg-white/92 p-3 shadow-2xl">
            <Image
          ...
          <div className="mt-6">
            ...
            <p className="mt-3 text-sm font-light leading-6 text-white/78">
              Business Analyst / Product Analyst based in Toronto, ON.
            </p>
          </div>
